...
(function() {
  ...
  function connect_to_chat_firebase(){
	...
	display_msg({m:"You will have the option to share a video w/ every message!<br>After five seconds with the webcam on you will be asked if you want to send videos. <br>To turn this on/off simple enter &#60;VT&#62;",c:"red"})
			...
			if ($(this).val() == "<VT>") { //turn off video
				...
				if (cur_video_blob == null) {
					...
					if (waiting) { //check if they said yes and send video or not depending
						...
						else fb_instance_stream.push({m:username+": " +wait_message, c: my_color});
						video = message = wait_vid = wait_message = null;
						waiting = false;
						$(this).val("");
						scroll_to_bottom(0);
					}
						...
						message.innerHTML = "<p>Would you like to send this video with your message? (y/n)</p>";
						...
						source.src =  URL.createObjectURL(base64_to_blob(wait_vid));
